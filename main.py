...
class StressApp:
    ...
    def update_frame(self):
        ...
        cv2.rectangle(frame, (frame.shape[1]-90, 10), (frame.shape[1]-10, 60), (0,0,0), -1)
        cv2.putText(frame, timer_text, (frame.shape[1]-90, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.90, (255,255,255), 2)
        # Convert to ImageTk
